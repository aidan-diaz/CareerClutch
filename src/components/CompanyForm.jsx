const CompanyForm = ({ onSubmit, handleCompanyNameChange, handleJobTitleNameChange, handleLocationNameChange, handleLinkChange, newCompanyName, newJobTitle, newLocation, link }) => {
    return (
        ...
        >
            ...
            <div>
                <button 
                    className="rounded-md bg-blue-600 py-2 px-4 border border-transparent text-center text-sm text-white transition-all shadow-md hover:shadow-lg focus:bg-blue-700 focus:shadow-none active:bg-blue-700 hover:bg-blue-700 active:shadow-none hover:cursor-pointer disabled:opacity-50 disabled:shadow-none ml-2" type="submit">
                        Add Company
                </button>
            </div>
        </form>
